...
$deploymentTemplatePath = ".\template.Application.json"
...
$resourceGroupName = "z-" `
                    ...
                    + "-" + $json.parameters.project_code.value `
                    + "-" + $json.parameters.app_code.value `
                    + "-" + $json.parameters.env_code.value `
                    + "-" + $json.parameters.corridor_code.value `
                    + "-" + $json.parameters.location_code.value `
                    + "-" + $json.parameters.appResourceGroup_index.value
